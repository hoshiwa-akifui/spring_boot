        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="admin" class="active-menu"><i class="fa fa-table"></i> 管理员列表</a>
                    </li>
                    <li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <a class="btn btn-primary" id="add">增加</a><input type="hidden" id="msg" value="${msg}"/>
                        <!-- 点击增加才显示的窗口-->
                        <div id="addWindow">
                            <div id="addWindowContent">
                                ...
                                <form action="" method="post" id="form">
                                    <table>
                                        ...
                                        <tr>
                                            <th>管理员账号：<input type="text" id="admin_account" name="admin_account" placeholder="请输入管理员账号"/></th>
                                        </tr>
                                        <tr>
                                            <th>管理员密码：<input type="password" id="admin_password" name="admin_password" placeholder="请输入管理员密码"/></th>
                                        </tr>
                                        <tr>
                        ...
                        <a class="btn btn-danger disabled" id="dtn" onclick="del();">批量删除</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>admin_reg_time</th>
                                            <th>admin_last_login_time</th>
                                            <th>admin_last_login_ip</th>
                                            <th>admin_status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <#list admins as admin>
                                        <tr class="odd gradeX" ondblclick="update(${admin.admin_id}, '${admin.admin_account}', '${admin.admin_password}');">
                                            ...
                                            <th>${admin.admin_reg_time}</th>
                                            <th>${admin.admin_last_login_time}</th>
                                            <th>${admin.admin_last_login_ip}</th>
                                            <th>${admin.admin_status}</th>
                                        </tr>
                                    </#list>
                                    </tbody>
                                </table>
